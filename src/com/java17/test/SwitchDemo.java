...
import com.java17.test.pollution.AirPollution;
import com.java17.test.pollution.WaterPollution;
...
public class SwitchDemo {
    ...
    int getDamageToPlanetV2(SingleUsePlastic plastic){
        return switch (plastic){
            case CUP : yield 100;
            case STRAW : yield 200;
            case BOTTLE,TAKE_AWAY_CONTAINERS : yield 300;
        };
    }
